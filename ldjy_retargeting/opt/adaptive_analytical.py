...
class AdaptiveOptimizerAnalytical(BaseOptimizer):
    ...
    def __init__(self, config: dict):
        ...
        # The optimizer.urdf_path override is loaded by BaseOptimizer before this
        # optimizer resolves kinematic indices.
    ...
    def _resolve_flex_indices(self):
        ...
        dimensions even when a custom URDF (``optimizer.urdf_path``)
